...
const FLASH_QUIZ_QA = [
  ...
  // ชุดคำถามเพิ่มเติม
  { q: "เราใช้อะไรรับรสอาหาร?", a: "ลิ้น" },
  { q: "เราใช้อะไรสัมผัสจับต้องสิ่งของ?", a: "มือ" },
  { q: "วันแรกของสัปดาห์ตามปฏิทินไทยคือวันอะไร?", a: "วันอาทิตย์" },
  { q: "วันสุดท้ายของสัปดาห์การทำงานทั่วไปคือวันอะไร?", a: "วันศุกร์" },
  { q: "3 คูณ 3 เท่ากับเท่าไหร่?", a: "9" },
  { q: "10 บวก 10 เท่ากับเท่าไหร่?", a: "20" },
  { q: "9 ลบ 4 เท่ากับเท่าไหร่?", a: "5" },
  { q: "6 หาร 3 เท่ากับเท่าไหร่?", a: "2" },
  { q: "ผึ้งให้อะไรเรากิน?", a: "น้ำผึ้ง" },
  { q: "นกร้องว่าอย่างไร?", a: "จิ๊บๆ" },
  { q: "ม้าร้องว่าอย่างไร?", a: "ฮี้ๆ" },
  { q: "สัตว์ชนิดใดที่ได้ชื่อว่าเป็นเพื่อนที่ซื่อสัตย์ที่สุดของมนุษย์?", a: "สุนัข" },
  { q: "พืชสร้างอาหารเองได้โดยกระบวนการใด?", a: "การสังเคราะห์แสง" },
  { q: "ดวงจันทร์โคจรรอบอะไร?", a: "โลก" },
  { q: "เทศกาลสงกรานต์ตรงกับเดือนอะไร?", a: "เมษายน" },
  { q: "วันแม่แห่งชาติของไทยตรงกับวันที่เท่าไหร่?", a: "12 สิงหาคม" },
  { q: "วันพ่อแห่งชาติของไทยตรงกับวันที่เท่าไหร่?", a: "5 ธันวาคม" },
  { q: "ไฟเหลืองแปลว่าอะไร?", a: "เตรียมตัว/ระวัง" },
  { q: "เราใส่รองเท้าที่อวัยวะส่วนไหน?", a: "เท้า" },
  { q: "หมวกใส่ที่ส่วนไหนของร่างกาย?", a: "ศีรษะ" },
];
